...
case "$attention_backend" in
    FLASH_ATTN | FLASH_ATTN_FP8_QDQ_SM80 | FLASH_ATTN_KV_FP8_QDQ_SM80 | TRITON_ATTN_FP8_SM80) ;;
    *)
        echo "ATTENTION_BACKEND must be FLASH_ATTN, FLASH_ATTN_FP8_QDQ_SM80, FLASH_ATTN_KV_FP8_QDQ_SM80, or TRITON_ATTN_FP8_SM80" >&2
        exit 2
        ;;
esac
