...
using K256 = W4A8GroupedGemmKernel<Shape<_256, _16>, Shape<_1, _1, _1>, Coop, CoopEpi>;
...
STABLE_TORCH_LIBRARY(h20_native_pingpong, m) {
...
STABLE_TORCH_LIBRARY_IMPL(h20_native_pingpong, CUDA, m) {
